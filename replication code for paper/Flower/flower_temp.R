...
gen_plots_cont_path <- function(){
    run <- cont_temper_path(conf_temp,temp_mod=temp_mod,smooth_mod=smooth_mod,samp_iter = 4000,ad=0.9) 
    plot_prior_a(run$history,label='flower')
    plot_norm_const(run$history,label='flower')
    plot_thetas(run$history,label='flower')
    plot_cross(run$history,label='flower')
}

gen_plots_cont_imp <- function(){
  run <- cont_temper_imp(conf_temp,temp_mod=temp_mod,smooth_mod=smooth_mod,samp_iter = 4000,ad=0.9) 
  plot_prior_a(run$history,label='flower')
  plot_norm_const(run$history,label='flower')
  plot_thetas(run$history,label='flower')
  plot_cross(run$history,label='flower')
...
gen_plots_disc_imp <- function(){
  run <- disc_temper_imp(temp_mod_disc=temp_mod_disc,samp_iter = 4000,ad=0.9) 
  plot_prior_a_disc(run$history,label='flower')
  plot_norm_const(run$history,label='flower')
  plot_thetas(run$history,label='flower')
  plot_cross(run$history,label='flower')
}

gen_plots_disc_rb <- function(){
  run <- disc_temper_rb(temp_mod_disc=temp_mod_disc,samp_iter = 4000,ad=0.9) 
  plot_prior_a_disc(run$history,label='flower')
  plot_norm_const(run$history,label='flower')
  plot_thetas(run$history,label='flower')
  plot_cross(run$history,label='flower')
...
plot_prior_a <- function(history,ts = c(1,3,5,7,10),label){
  ...
  ggsave(paste("priors_",label,".png",sep=''),grid_plot)
}
...
plot_norm_const <- function(history,ts = c(1,3,5,7,10),label){
  ...
  grid_plot <- plot_grid(plotlist=plots,labels=ts)
  ggsave(paste("zs_",label,".png",sep=''),grid_plot)
}
